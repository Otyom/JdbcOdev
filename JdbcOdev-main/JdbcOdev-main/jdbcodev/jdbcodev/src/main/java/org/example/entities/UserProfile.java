...
public class UserProfile extends BaseEntity{
    ...
    public UserProfile(int id, String createDate, String updateDate, org.example.entities.State state, int id1, String email, String username, String password, String name, String surname) {
